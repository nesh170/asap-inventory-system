...
class RequestTable(models.Model):
    ...
    def __str__(self):
        request_string = "Request has the following parameters: item: {item}, quantity_requested: {quantity_requested}, shopping_cart_id: {shopping_cart_id}".format
        return request_string(item=self.item, quantity_requested=self.quantity_requested, shopping_cart_id=self.shopping_cart)